...
2DFatJetMassPlotter.py -f ROOTAnalysis.txt -x --region Signal --nHiggs2bb
...
2DFatJetMassPlotter.py -f ROOTAnalysis.txt -x --region 1b1mu
2DFatJetMassPlotter.py -f ROOTAnalysis.txt -x --region 1b2mu

2DFatJetMassPlotter.py -f ROOTAnalysis.txt -x --region Signal --HT 1500
2DFatJetMassPlotter.py -f ROOTAnalysis.txt -x --region Signal --HT 1500 --nHiggs2bb
...
2DFatJetMassPlotter.py -f ROOTAnalysis.txt -x --region 1b1mu --HT 1500
2DFatJetMassPlotter.py -f ROOTAnalysis.txt -x --region 1b2mu --HT 1500
